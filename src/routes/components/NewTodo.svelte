<script>
	...
	// unlike adding a project, a new todo is automatically rendered without event.update false!?
	const beforeSubmit = () => {
...
<div class="NewTodo">
	<ul>
		...
		{:else}
			<li>
				<form method="POST" action="apis/todo?/addTodoToDB" use:enhance={beforeSubmit}>
					<div class="todo-header todo-header-input">
						<input
							class="todo-name todo-input-field"
							placeholder="Name"
							name="todoName"
							autocomplete="off"
							autofocus
					...
					<div class="todo-data">
						<textarea class="todo-input-field todo-notes" placeholder="Notes" name="notes" />
