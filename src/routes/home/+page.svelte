<script>
	...
	function filterTodoList() {
		...
		if (selectedProjectID == -1) {
			...
			filteredTodoList = todoListData.filter((todo) => todo.project == selectedProjectID);
		}
		filterByDate();
	}
	// sort the filtered todos by date
	function sortTodosByDate() {
		filteredTodoList = filteredTodoList.sort((a, b) => (a.dueDate > b.dueDate ? 1 : -1));
	}
	afterUpdate(() => {
...
<div class="full-container">
	<div class="side-panel">
		...
		<ProjectList {projectListData} bind:selectedProjectID />
	</div>
